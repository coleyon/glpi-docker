...
ARG VERSION_GLPI=${VERSION_GLPI:-9.2.4}
...
ARG LOCALEDEF_INPUT_FILE=${LOCALEDEF_INPUT_FILE:-ja_JP}
ARG LOCALEDEF_OUTPUT_PATH=${LOCALEDEF_OUTPUT_PATH:-/usr/lib/locale/ja_JP.UTF-8}
ENV TZ=${TIMEZONE}
